                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Align(
                              alignment: Alignment.centerLeft,
                              child: featuredProduct.text.white
                                  .fontFamily(bold)
                                  .size(18)
                                  .make()),
                          SingleChildScrollView(
                    ...
                    GridView.builder(
                        ...
                        itemBuilder: ((context, index) {
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Image.asset(imgP2,width: 200, fit: BoxFit.fill ,),
                              const Spacer(),
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 8),
                                child: "demo name".text.fontFamily(semibold).color(darkFontGrey).make(),
                              ),
                            
                              10.heightBox,
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 8.0),
                                child: "\$999".text.color(redColor).fontFamily(bold).size(16).make(),
                              ),
                              10.heightBox,
                            ],
